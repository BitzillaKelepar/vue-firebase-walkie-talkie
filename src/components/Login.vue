<template>
  <div class="h-screen flex justify-center items-center">
    <div class="flex flex-col items-center bg-sky-50 rounded-lg p-8 shadow-lg w-[400px] h-[300px]">
      <h1 class="text-3xl font-poppins mb-3">Login to Account</h1>
      ...
      <button @click="login" class="mt-3.5 place-content-center bg-sky-600 border-sky-600 border-2 text-sky-50 py-2 px-4 w-[100px] rounded-lg font-poppins hover:border-gray-700 hover:bg-gray-700">Login</button>
    </div>
